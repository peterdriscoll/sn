...
/*
		TEST_METHOD(TestStringPartialAssert)
		{
			Initialize();
			Manager manager(AssertErrorHandler);
			{
				...
				y.PartialEvaluate().Equivalent(z.PartialEvaluate()));
				z.PartialEvaluate().Equivalent(y.PartialEvaluate()));
				(String("dog") == y).PartialEvaluate().Equivalent((String("dog") == z).PartialEvaluate()));
				(z == "dog").AssertAction();
				//	 y.Evaluate().Equivalent(String("dog")) );
			}
			Cleanup();
		}

		TEST_METHOD(TestStringPartialAssert2)
		{
			Initialize();
			Manager manager(AssertErrorHandler);
			{
				...
				SN_DECLARE(a);
				SN_DECLARE(b);
				(String("dog") + a == b).PartialAssertAction();
				(b == "dogcat").AssertAction();
				(a.Evaluate().Equivalent(String("cat"))));
			}
			{
				Transaction transaction;

				SN_DECLARE(a);
				(String("dog") + a == String("dogcat")).PartialAssertAction();
				(a == String("cat")).PartialAssertAction();
				SN_DECLARE(b);
				(b + String("cat") == String("dogcat")).PartialAssertAction();
				(b == String("dog")).PartialAssertAction();
				SN_DECLARE(c);
				(String("dog") + String("cat") == c).PartialAssertAction();
				(c == String("dogcat")).PartialAssertAction();
			}
			{
				Transaction transaction;

				SN_DECLARE(a);
				(String("dogcat").SubtractLeft(String("dog")) == a).PartialAssertAction();
				(a == String("cat")).PartialAssertAction();
				SN_DECLARE(b);
				(String("dogcat").SubtractLeft(b) == String("cat")).PartialAssertAction();
				(b == String("dog")).PartialAssertAction();
				SN_DECLARE(c);
				(c.SubtractLeft(String("dog")) == String("cat")).PartialAssertAction();
				(c == String("dogcat")).PartialAssertAction();
			}
			{
				Transaction transaction;
				...
				SN_DECLARE(a);
				(String("dogcat").SubtractRight(String("cat")) == a).PartialAssertAction();
				(a == String("dog")).PartialAssertAction();
				SN_DECLARE(b);
				(String("dogcat").SubtractRight(b) == String("dog")).PartialAssertAction();
				(b == String("cat")).PartialAssertAction();
				SN_DECLARE(c);
				(c.SubtractRight(String("cat")) == String("dog")).PartialAssertAction();
				(c == String("dogcat")).PartialAssertAction();
			}
			Cleanup();
		}
