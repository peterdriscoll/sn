#if !defined(SNI_EVALUATE_H_INCLUDED)
#define SNI_EVALUATE_H_INCLUDED
...
namespace SNI
{
	class SNI_Evaluate : public SNI_Unary
	{
		PGC_CLASS(SNI_Evaluate)
	public:
		SNI_Evaluate();
		virtual ~SNI_Evaluate();
...
#endif // !defined(SNI_EVALUATE_H_INCLUDED)
