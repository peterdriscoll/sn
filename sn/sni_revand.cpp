...
namespace SNI
{
	...
	{
		return skynet::RevAnd.PrimaryFunctionExpression(p_Right, p_Result);
	}
	...
	SN::SN_Error SNI_RevAnd::UnifyElement(long p_Depth, SN::SN_Expression *p_ParamList, SNI_World **p_WorldList, long p_CalcPos, long p_TotalCalc, SNI_WorldSet *worldSet, const SNI_Expression *p_Source) const
	{
