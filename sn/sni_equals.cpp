...
namespace SNI
{
	...
	{
		LOGGING(SN::LogContext context("SNI_Equals::PartialCall ( " + DisplaySnExpressionList(p_ParameterList) + " )"));
	...
	{
		LOGGING(SN::LogContext context("SNI_Equals::PartialUnify ( " + DisplaySnParameterList(p_ParameterList) + " = " + p_Result.DisplaySN() + " )"));
