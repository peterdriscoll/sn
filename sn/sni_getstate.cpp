...
namespace SNI
{
	...
	std::string SNI_GetState::GetTypeName() const
	{
		return "GetState";
	}

	std::string SNI_GetState::DisplayCpp() const
	{
		return "SN::GetState";
	}

	std::string SNI_GetState::DisplaySN(long /*priority*/, SNI_DisplayOptions & /*p_DisplayOptions*/) const
	{
		return "GetState";
	}
	...
	std::string SNI_GetState::DisplayCall(long priority, SNI_DisplayOptions &p_DisplayOptions, size_t p_NumParams, SN::SN_Expression *p_ParamList, const SNI_Expression *p_DebugSource) const
	{
