#if !defined(SNI_SQUAREROOT_H_INCLUDED)
#define SNI_SQUAREROOT_H_INCLUDED
...
namespace SNI
{
	class SNI_SquareRoot : public SNI_Unary
	{
		PGC_CLASS(SNI_SquareRoot)
	public:
		SNI_SquareRoot();
		virtual ~SNI_SquareRoot();
...
#endif // !defined(SNI_SQUAREROOT_H_INCLUDED)
