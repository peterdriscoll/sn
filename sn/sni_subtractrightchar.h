#if !defined(SNI_SUBTRACTRIGHTCHAR_H_INCLUDED)
#define SNI_SUBTRACTRIGHTCHAR_H_INCLUDED
...
namespace SNI
{
	class SNI_SubtractRightChar : public SNI_Unary
	{
		PGC_CLASS(SNI_SubtractRightChar)
	public:
		SNI_SubtractRightChar();
		virtual ~SNI_SubtractRightChar();
...
#endif // !defined(SNI_SUBTRACTRIGHTCHAR_H_INCLUDED)
