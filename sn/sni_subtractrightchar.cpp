...
namespace SNI
{
	...
	string SNI_SubtractRightChar::DisplaySN(long /*priority*/, SNI_VariablePointerList & /*p_DisplayVariableList*/) const
	{
		return "SubtractRightChar";
	}
	...
	string SNI_SubtractRightChar::GetOperator() const
	{
		return "SubtractRightChar";
	}
