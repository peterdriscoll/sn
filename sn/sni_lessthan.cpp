...
namespace SNI
{
	...
	void SNI_LessThan::PromoteMembers()
	{
	}
	...
	string SNI_LessThan::DisplaySN(long /*priority*/, SNI_VariablePointerList & /*p_DisplayVariableList*/) const
	{
		return "<";
	}
	...
	SN::SN_Expression SNI_LessThan::PrimaryFunctionExpression(const SN::SN_Expression &p_Left, const SN::SN_Expression &p_Right) const
	{
