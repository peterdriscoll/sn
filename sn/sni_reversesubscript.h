#if !defined(SNI_REVERSESUBSCRIPT_H_INCLUDED)
#define SNI_REVERSESUBSCRIPT_H_INCLUDED
...
namespace SNI
{
	class SNI_ReverseSubscript : public SNI_Binary
	{
		PGC_CLASS(SNI_ReverseSubscript)
	public:
		SNI_ReverseSubscript();
		virtual ~SNI_ReverseSubscript();
...
#endif // !defined(SNI_REVERSESUBSCRIPT_H_INCLUDED)
