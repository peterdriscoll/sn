...
namespace SNI
{
	...
	std::string SNI_Not::GetTypeName() const
	{
		return "Not";
	}

	std::string SNI_Not::DisplayCpp() const
	{
		return "SN::Not";
	}

	std::string SNI_Not::DisplaySN(long /*priority*/, SNI_DisplayOptions & /*p_DisplayOptions*/) const
	{
		return "!";
	}
	...
	std::string SNI_Not::GetOperator() const
	{
		return "!";
	}
