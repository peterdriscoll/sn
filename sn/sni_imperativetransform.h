#if !defined(SNI_IMPERATIVETRANSFORM_H_INCLUDED)
#define SNI_IMPERATIVETRANSFORM_H_INCLUDED
...
namespace SNI
{
	class SNI_ImperativeTransform : public SNI_Unary
	{
		PGC_CLASS(SNI_ImperativeTransform)
	public:
		SNI_ImperativeTransform();
		virtual ~SNI_ImperativeTransform();
		...
		SN::SN_Expression DoTransform(const SN::SN_Expression &p_Param, long p_MetaLevel) const;
...
#endif // !defined(SNI_IMPERATIVETRANSFORM_H_INCLUDED)
