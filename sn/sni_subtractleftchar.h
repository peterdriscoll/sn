#if !defined(SNI_SUBTRACTLEFTCHAR_H_INCLUDED)
#define SNI_SUBTRACTLEFTCHAR_H_INCLUDED
...
namespace SNI
{
	class SNI_SubtractLeftChar : public SNI_Unary
	{
		PGC_CLASS(SNI_SubtractLeftChar)
	public:
		SNI_SubtractLeftChar();
		virtual ~SNI_SubtractLeftChar();
...
#endif // !defined(SNI_SUBTRACTLEFTCHAR_H_INCLUDED)
