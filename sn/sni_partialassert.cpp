...
namespace SNI
{
	...
	std::string SNI_PartialAssert::GetTypeName() const
	{
		return "PartialAssert";
	}

	std::string SNI_PartialAssert::DisplayCpp() const
	{
		return "PartialAssert";
	}

	std::string SNI_PartialAssert::DisplaySN(long /*priority*/, SNI_DisplayOptions & /*p_DisplayOptions*/) const
	{
		return "PartialAssert";
	}
	...
	std::string SNI_PartialAssert::DisplayCall(long priority, SNI_DisplayOptions & p_DisplayOptions, size_t p_NumParams, SN::SN_Expression * p_ParamList, const SNI_Expression * p_DebugSource) const
	{
	...
	SN::SN_Expression SNI_PartialAssert::CallArray(SN::SN_Expression* p_ParamList, long p_MetaLevel, const SNI_Expression* p_Source) const
	{
