...
namespace SNI
{
	...
	std::string SNI_HasA::GetTypeName() const
	{
		return "HasMember";
	}

	std::string SNI_HasA::DisplayCpp() const
	{
		return "SN::HasMember";
	}

	std::string SNI_HasA::DisplaySN(long /*priority*/, SNI_DisplayOptions & /*p_DisplayOptions*/) const
	{
		return "in";
	}
