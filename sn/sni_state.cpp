...
namespace SNI
{
	/*static*/ SNI_Class* SNI_State::PeekClass()
    {
        return SNI_User::GetCurrentUser()->GetPointer<SNI_State, SNI_Class>();
    }
	...
	SN::SN_Expression SNI_State::Type() const
    {
        return PeekClass();
    }

    SN::SN_Expression SNI_State::Type()
	{
		return Class();
	}
