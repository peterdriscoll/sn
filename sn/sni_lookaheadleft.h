#if !defined(SNI_LOOKAHEADLEFT_H_INCLUDED)
#define SNI_LOOKAHEADLEFT_H_INCLUDED
...
namespace SNI
{
	class SNI_LookaheadLeft : public SNI_Unary
	{
		PGC_CLASS(SNI_LookaheadLeft)
	public:
		SNI_LookaheadLeft();
		virtual ~SNI_LookaheadLeft();
...
#endif // !defined(SNI_LOOKAHEADLEFT_H_INCLUDED)
